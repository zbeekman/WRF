...
!#endif
   ...
   use da_control, only : trace_use, var4d_bin, trajectory_io, &
      ...
      ims, ime, jms, jme, kms, kme, ips, ipe, jps, jpe, kps, kpe, fgat_rain_flags, var4d_bin_rain, balance_error, use_wpec
   ...
   use da_dynamics, only : da_balance_equation_lin,da_balance_equation_adj,&
       da_balance_geoterm_lin,da_balance_geoterm_adj,da_balance_cycloterm_lin,&
