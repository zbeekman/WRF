module da_obs_io
   ...
   use da_control, only : missing_r, fmt_each, fmt_info, trace_use, &
      ...
      use_airepobs,use_bogusobs,use_gpspwobs,use_gpsztdobs,use_gpsrefobs,use_gpsephobs,use_geoamvobs, &
      ...
      max_buoy_input, max_gpsref_input, max_gpseph_input, max_gpspw_input, max_geoamv_input, &
      ...
      sound, mtgirs,synop, pilot, satem, geoamv, polaramv, airep, gpspw, gpsref, gpseph, &
      ...
      var_wind, pi, kds, kde, gpseph_nonlocal, gpseph_loadbalance
   ...
   use da_define_structures, only : iv_type, multi_level_type, multi_level_type_BUFR, &
      ...
      radar_each_level_type, info_type, model_loc_type,gpsref_type, gpseph_type, rain_single_level_type, rain_each_type
